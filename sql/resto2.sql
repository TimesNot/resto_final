...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `adminU` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idU`),
...
(666, 'admin@bts.sio', '63a9f0ea7bb98050796b649e85481845', 'admin', 1);
