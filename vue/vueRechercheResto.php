...
<form action="./?action=recherche&critere=<?= $critere ?>" method="POST">
    ...
    switch ($critere) {
        ...
        case "adresse":
            ...
            <input type="text" name="cpR" pattern="[0-9]{5}" maxlength="5" placeholder="code postal" value="<?= $cpR ?>"/><br />
...
//            foreach ($mesTypeCuisinePreferes as $unTC) {
        ...
        case "multi":
            ...
            <input type="text" name="voieAdrR" placeholder="rue" value="<?= $voieAdrR ?>"/><br />
            <input type="text" name="cpR" pattern="[0-9]{5}" maxlength="5" placeholder="code postal" value="<?= $cpR ?>"/>
